          ...
          <Dialog open={isDialogOpen} onOpenChange={setIsDialogOpen}>
            ...
            <DialogContent className="max-w-2xl">
              <DialogHeader>
                ...
                <DialogDescription>Configure storage backend settings for file uploads</DialogDescription>
              </DialogHeader>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  <div>
                    <Label htmlFor="bucket_name">
                      Bucket Name {editingConfig.storage_type === "vercel_blob" ? "(Optional)" : ""}
                    </Label>
                    <Input
                      id="bucket_name"
                      value={editingConfig.bucket_name || ""}
                      onChange={(e) => handleConfigChange("bucket_name", e.target.value)}
                      placeholder={editingConfig.storage_type === "vercel_blob" ? "Auto-managed" : "my-upload-bucket"}
            ...
            <TableBody>
              {storageConfigs.map((config) => (
                <TableRow key={config.id}>
                  ...
                  <TableCell className="capitalize">{config.storage_type.replace("_", " ")}</TableCell>
                  <TableCell>
