...
export default function ConfigurationManager({
                                                 ...
                                                 onSaveStorage,
                                                 onDeleteStorage,
                                             }: Readonly<ConfigurationManagerProps>) {
    ...
    const addColumn = () => {
        ...
        const newColumn: UploadConfigurationColumn = {
            ...
            // ramdom id number
            id: Math.floor(Math.random() * 1000000), // NOSONAR
                                    ...
                                    <TabsContent value="columns" className="space-y-6">
                                        <div className="flex justify-between items-center">
                                            ...
                                            <Button onClick={addColumn} size="sm"
                                                    disabled={isLoading ?? submitLoading ?? apiCallLoading}>
                                                <Plus className="h-4 w-4 mr-2"/>
                                                Add Column
                                            </Button>
                                        </div>
                                            ...
                                            {columns?.length ?
                                                            ...
                                                            <div>
                                                                ...
                                                                >
                                                                    ...
                                                                    <SelectContent>
                                                                        ...
                                                                        <SelectItem
                                                                            value="datetime">Datetime</SelectItem>
                                                                    </SelectContent>
                                                                </Select>
                                                            </div>
                                                            <div className="flex items-end gap-0">
                                                                <div
                                                                    className=" flex flex-col items-start justify-start mx-0">
                                                                    <div
                                                                        className="flex flex-row items-end justify-items-center justify-center mb-2">
                                                                        <Switch
                                                                    ...
                                                                    <div
                                                                        className="flex flex-row items-end justify-items-center justify-center">
                                                                        <Switch
                                                                            className={"h-4 w-9 [&>span]:h-3 [&>span]:w-3 mr-1"}
                                                                            checked={column.valuesRequired}
                                                                            onCheckedChange={(checked) => updateColumn(index, "valuesRequired", checked)}
                                                                        />
                                                                        <Label className="text-xs">Values
                                                                            Required</Label>
                                                                    </div>
                                                                </div>
                                                ...
                                                (
                                                    columns.length === 0 && (
                                                        ...
                                                        <span
                                                            className="text-muted-foreground">No columns defined yet</span>
                                                        </div>
                                                    )
                                                )}
                                        </div>
