            ...
            >
              {selectedFile ? (
                <div className="space-y-4">
                  ...
                  {!uploading && <Button onClick={handleUpload}>Upload File</Button>}
                </div>
              ) : (
                <div className="space-y-4">
                        ...
                        {uploadResult.status === "partially_completed" && (
                          <div>
                            ...
                            <p className="text-sm text-yellow-700 mt-1">
                              Processed {uploadResult.processed_rows} of {uploadResult.total_rows} rows (
                              {uploadResult.error?.details?.row_level_errors?.total} errors found)
                            </p>
                          </div>
                        )}
                        {uploadResult.status === "failed" && (
                          <div>
                            <span className="text-red-800 font-medium">{uploadResult.error?.message}</span>
                ...
                {validationErrors.length > 0 && (
                  <Card>
                    <CardHeader>
                      ...
                      <CardDescription>{validationErrors.length} validation errors found in your file</CardDescription>
                    </CardHeader>
                    <CardContent>
                                ...
                                {validationErrors
                                  ...
                                  .map((error, index) => (
                                    <TableRow key={index}>
                                      ...
                                      <TableCell>
                                        {error.column && <Badge variant="outline">{error.column}</Badge>}
                                      </TableCell>
                                      <TableCell>
