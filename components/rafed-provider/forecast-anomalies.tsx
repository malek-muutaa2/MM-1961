      ...
      <Card>
        <CardContent className="p-4">
          <p className="text-sm text-muted-foreground">
            Anomalies are detected by comparing your forecast with historical patterns, seasonal trends, and similar
            ...
            {anomalies.length > 0 ? (
              anomalies.map((anomaly) => (
                <TableRow key={anomaly.id}>
                  ...
                  <TableCell className="text-right">{anomaly.forecastValue.toLocaleString()}</TableCell>
      ...
      <Dialog open={acknowledgeDialogOpen} onOpenChange={setAcknowledgeDialogOpen}>
        <DialogContent className="sm:max-w-md">
          <DialogHeader>
            ...
            <DialogDescription>
              You are acknowledging an anomaly for {selectedAnomaly?.productName} ({selectedAnomaly?.sku}). This will be
          ...
          <div className="space-y-4 py-4">
            <div className="space-y-2">
              ...
              <div className="rounded-md bg-muted p-3 text-sm">
                ...
                <p>
                  <span className="font-medium">Forecast Value:</span> {selectedAnomaly?.forecastValue.toLocaleString()}
                </p>
                <p>
                  <span className="font-medium">Expected Range:</span> {selectedAnomaly?.expectedRange}
                </p>
              </div>
            </div>
            <div className="space-y-2">
