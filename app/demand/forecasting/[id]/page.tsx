                ...
                <div className="divide-y">
                  {monthlyForecastData.map((month, index) => (
                    <div key={index} className="grid grid-cols-4 p-2">
                      ...
                      <div className="col-span-1 text-center">{month.forecast.toLocaleString()}</div>
                      <div className="col-span-1 text-center">{month.actual ? month.actual.toLocaleString() : "—"}</div>
                      ...
                      <div className="col-span-1 text-center">
                        {hospital.confidence > 0 ? (
                          <Badge
                            variant="outline"
                            className={
                              hospital.confidence >= 90
                                ? "bg-green-50 text-green-700 border-green-200"
                                : hospital.confidence >= 80
